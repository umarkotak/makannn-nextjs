            ...
            <div className="flex flex-col relative rounded-lg shadow-xl">
              <a className="absolute top-0 p-2 text-white w-full">
                <div className={`flex justify-end text-sm text-[#a8dadc]`}>
                  <span className="text-[#fca311]"><i className="fa-solid fa-star"></i> 4.5</span>
                </div>
              </a>
              ...
              <a className="absolute top-[162px] p-2 text-white w-full">
                <div className={`flex text-sm text-[#a8dadc]`}>
                  <img src="/images/gojek.png" className="h-[18px] w-[18px] border rounded-full bg-white" />
                  <img src="/images/grab.png" className="h-[18px] w-[18px] ml-1  border rounded-full bg-white" />
                  <img src="/images/shopee.ico" className="h-[18px] w-[18px] ml-1  border rounded-full bg-white" />
                  <img src="/images/traveloka.png" className="h-[18px] w-[18px] ml-1  border rounded-full bg-white" />
                </div>
              </a>
